...
const SAFEMARS_ADDRESS = '0xB632f92596098EFf2f6930005051a1C5c2784aB5'
export const SAFEMARS: { [chainId in ChainId]: Token } = {
    [ChainId.MAINNET]: new Token(ChainId.MAINNET, SAFEMARS_ADDRESS, 9, 'BullyeX', 'BLX'),
    [ChainId.BSCTESTNET]: new Token(ChainId.BSCTESTNET, '0x0000000000000000000000000000000000000000', 9, 'BULLYRISE', 'BULLYRISE')
}
